...
/// Перечисление команд исполнения
...
/// Авторестарт после завершения процесса
public enum AutoRestart: String, Codable {
	case always
	case never
	case unexpected
}

/// Успешное или не успешное завершение процесса
...
public enum Signals: Int32, CaseIterable, Codable {
